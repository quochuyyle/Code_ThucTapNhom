...
namespace Quan_li_diem_HS_tieu_hoc
{
    public  class LuuTruDanhSach
    {
        ...
        {
            string strSQL = "select h.Ho,h.Ten,h.MaHS,h.GioiTinh,h.NgaySinh,Lop from HocSinh h,Lop l where h.MaLop=l.MaLop ORDER BY TEN ASC";
        ...
        public  Diem  HienThiDiemCuaHocSinhTheoMaHS(string MaHS)
        {
            ...
            if(dt.Rows.Count>0)
            {
                ...
                objDiem.ANH15 = "" + dt.Rows[0]["ANH15"];
                objDiem.ANH60 = "" + dt.Rows[0]["ANH60"];
                objDiem.ANHHK = "" + dt.Rows[0]["ANHHK"];
                objDiem.ANHTB = "" + dt.Rows[0]["ANHTB"];
        ...
        {
            string strUpdate = "Update Diem set Toan15=@Toan15,Toan60=@Toan60,ToanHK=@ToanHK,ToanTB=@ToanTB,Van15=@Van15,Van60=@Van60,VanHK=@VanHK,VanTB=@VanTB,ANH15=@ANH15,ANH60=@ANH60,ANHHK=@ANHHK,ANHTB=@ANHTB,DIA15=@DIA15,DIA60=@DIA60,DIAHK=@DIAHK,DIATB=@DIATB,SU15=@SU15,SU60=@SU60,SUHK=@SUHK,SUTB=@SUTB";
            ...
            pars[8] = new SqlParameter("@ANH15", SqlDbType.NVarChar, 50);
            pars[8].Value = objDiem.ANH15;
            pars[9] = new SqlParameter("@ANH60", SqlDbType.NVarChar, 50);
            pars[9].Value = objDiem.ANH60;
            pars[10] = new SqlParameter("@ANHHK", SqlDbType.NVarChar, 50);
            pars[10].Value = objDiem.ANHHK;
            pars[11] = new SqlParameter("@ANHTB", SqlDbType.NVarChar, 50);
